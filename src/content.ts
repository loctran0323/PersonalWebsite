...
export const experiences: Experience[] = [
  ...
  // },
  {
    ...
    detail: "M&A advisory — pitch books, financing proposals, and cross-border target sourcing.",
    tags: ["Investment Banking", "M&A", "Corporate Finance"],
    details: [
      "Drafted pitch books and financing proposals for M&A advisory mandates, and sourced domestic and cross-border acquisition opportunities through research on ECM, sector trends, and regulatory developments.",
      "Built a bottom-up target list of US semiconductor materials and components suppliers, screening 35+ companies against a 10-criteria framework with EBITDA built from primary SEC filings.",
      "Authored capital-raise screening memos on critical-minerals and battery supply-chain targets, analyzing technology, competitive position, and risk while assessing fit for the firm's Korean investor base.",
    ],
  },
  {
    id: "02",
    logo: "https://jsf.co/wp-content/uploads/2024/03/Lambent-Data-Inc.jpg",
    role: "AI Engineering Intern Lead",
...
export const leadership: Leadership[] = [
  {
    ...
    details: [
      "Co-founded and scaled the club from inception to 185+ active members, establishing it as one of Princeton's primary pipelines into quantitative finance.",
      "Secured $74K+ in corporate sponsorships from leading quant firms, funding events, competitions, and operational growth.",
      "Launched and ran the club's first quantitative trading competition, drawing 100+ participants across the university and partnering with industry sponsors to design the format.",
      "Organized educational programming on quant career paths, including guest sessions with Jane Street, Citadel, and Tower Research, alongside technical interview prep and hands-on coding projects to introduce students to systematic trading.",
    ],
  },
  {
    id: "02",
    ...
    detail: "Member of Princeton's competitive electric speedboating team.",
    details: [],
  },
  {
    id: "03",
    role: "Member",
    org: "Princeton Powerlifting Club",
    period: "Sep 2024 – May 2026",
    detail: "Member of the Princeton Powerlifting Club.",
    details: [],
  },
  {
    id: "04",
    ...
    period: "Sep 2024 – May 2026",
    detail: "Member of the Vietnamese Student Association.",
    details: [],
  },
];
